function drawScatterPlot(svgId, plotData, xField, yField, rField, xLabel, yLabel) {
  d3.json(plotData, function(data) {
    /* filter or not
    data = data.filter(function (twp) {
      console.log(twp.unsafe_non_drinking_water);
      // return twp.unsafe_non_drinking_water < 100000;
      return twp.unsafe_non_drinking_water < 30000;
    })
    */
    console.log(data);
