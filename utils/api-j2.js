...
function getChartData(obj, region) {
  ...
  dataObj.unsafe_drinking_water = obj[0]["unprotected_well_or_spring"]
  ...
  dataObj.unsafe_drinking_water_percentage = (100 * dataObj.unsafe_drinking_water / obj[0].total).toFixed(2);

  result.push(dataObj);
  console.log(result);
  var json = JSON.stringify(result);
  fs.writeFile("j2.json", json, "utf8");
}
